...
Defines how the Xconvert GUI application starts up, shuts down, and cleans up
in-flight work. Specifically, it governs process termination when the window is
closed and the handling of a running conversion when the app quits.
